...
def parse_sheet(file_path: str, sheet: str,
    ...
    for _, row in data.iterrows():
        ...
        # Skip SAC subtotal rows — underscore means aggregation group
        # e.g. "62510_" is a subtotal of 625100-625109
        # Individual accounts are also present → would double-count
